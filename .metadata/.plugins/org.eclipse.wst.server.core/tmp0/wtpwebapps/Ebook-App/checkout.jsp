...
<%@page isELIgnored="false" %>  
 <%@ page import="com.entity.Cart" %>
  <%@ page import="com.DAO.CartDAOlmpl" %>
				...
				<div class="card bg-white">
					...
					<h3 class="text-center text-success">Your Selected Item</h3>
						<table class="table table-striped">
							  ...
							  CartDAOlmpl dao = new CartDAOlmpl(DBConnect.getConn());
							    ...
							    <div class="form-group col-md-6">
							      ...
							      <input type="text" name="username" class="form-control" id="inputEmail4" value ="${userobj.name }" required>
							    	...
							    	<div class="form-group col-md-6">
								      ...
								      <input type="email" name="email" class="form-control" id="inputEmail4" value="${userobj.email }" required>
							    </div>
							  </div>
